...
# gnome knows best
dnf5 install -y gnome-shell nautilus gnome-extensions-app gnome-console gnome-mines gnome-control-center sushi gnome-backgrounds gnome-system-monitor gnome-text-editor ptyxis
